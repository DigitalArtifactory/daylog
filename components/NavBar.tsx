  ...
  return (
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        <li className={`nav-item ${homePattern.test(path) ? 'active' : ''}`}>
          <a
            className={`nav-link ${homePattern.test(path) ? 'active' : ''}`}
            href="/"
          >
        ...
        <li
          className={`nav-item ${
            boardPattern.test(path) || notePattern.test(path) ? 'active' : ''
          }`}
        >
          <a
            className={`nav-link ${
        ...
        <li className={`nav-item ${profilePattern.test(path) ? 'active' : ''}`}>
          <a
            className={`nav-link ${profilePattern.test(path) ? 'active' : ''}`}
      ...
      {user?.role === 'admin' && (
        <ul className="navbar-nav mb-2 mb-lg-0">
          <li className={`nav-item ${adminPattern.test(path) ? 'active' : ''}`}>
            <a
              className={`nav-link ${adminPattern.test(path) ? 'active' : ''}`}
              href="/admin"
            >
              <span className="nav-link-icon d-md-none d-lg-inline-block">
                <svg
